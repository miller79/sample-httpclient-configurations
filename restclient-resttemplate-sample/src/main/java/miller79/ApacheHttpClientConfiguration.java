...
/**
 * Configuration class for Apache HttpClient 5 used by RestTemplate and RestClient.
 * 
 * <p>This configuration demonstrates how to properly configure low-level HTTP client settings
 * including connection pooling, timeouts, and keep-alive behavior. These settings are critical
 * for production applications to ensure resilience, performance, and proper resource management.
 * 
 * <p><b>Key Configuration Areas:</b>
 * <ul>
 *   <li><b>Connection Pooling:</b> Controls the maximum number of concurrent connections</li>
 *   <li><b>Timeouts:</b> Defines various timeout thresholds for connection and response handling</li>
 *   <li><b>Keep-Alive:</b> Manages TCP keep-alive settings to maintain persistent connections</li>
 *   <li><b>Connection Lifecycle:</b> Controls how long connections can live and when to evict idle ones</li>
 * </ul>
 * 
 * <p>All configuration values are externalized via {@link ApacheHttpClientConfigurationProperties}
...
public class ApacheHttpClientConfiguration {
    ...
    /**
     * Creates a configured {@link CloseableHttpClient} with connection pooling and custom timeout settings.
     * 
     ...
     *   <li><b>Connection Configuration:</b> Defines connection lifecycle (time-to-live)</li>
     *   <li><b>Connection Pool:</b> Manages a pool of reusable HTTP connections</li>
     *   <li><b>Automatic Eviction:</b> Removes expired and idle connections automatically</li>
     * </ul>
     * 
     * <p><b>Timeout Hierarchy:</b>
     * <ol>
     *   <li>Response Timeout - Maximum time to wait for server response</li>
     *   <li>Socket Timeout (SO_TIMEOUT) - Socket-level read timeout (matches response timeout)</li>
     *   <li>Connection Time-to-Live - Maximum lifetime of a connection in the pool</li>
     *   <li>Idle Eviction - Connections idle longer than this are removed from pool</li>
     * </ol>
     * 
     ...
     * @see PoolingHttpClientConnectionManagerBuilder for connection pool configuration
     */
    @Bean
    ...
    /**
     * Creates a {@link RestClientCustomizer} that configures all RestClient.Builder instances
     * to use the custom {@link CloseableHttpClient}.
     * 
     * <p>This customizer is automatically applied to any {@link org.springframework.web.client.RestClient.Builder}
     * bean in the application context. It replaces the default HTTP client with our pooled,
     * timeout-configured client.
     * 
     * <p><b>Usage:</b> Any RestClient.Builder injected into your beans will automatically
     * use the configured HTTP client with all the custom timeout and pooling settings.
     * 
    ...
    /**
     * Creates a {@link RestTemplateBuilder} configured to use the custom {@link CloseableHttpClient}.
     * 
     * <p>This builder is automatically injected with Spring Boot's default configuration via
     * {@link RestTemplateBuilderConfigurer}, and then customized to use our pooled HTTP client
     * instead of the default client.
     * 
     * <p><b>Usage:</b> Inject this RestTemplateBuilder into your beans to create RestTemplate
     * instances that use the custom HTTP client:
     * <pre>{@code
     * @Autowired
