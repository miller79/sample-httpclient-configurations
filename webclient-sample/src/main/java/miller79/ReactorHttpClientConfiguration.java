...
class ReactorHttpClientConfiguration {
    ...
    /**
     * Creates a {@link ClientHttpConnectorBuilder} with custom Reactor Netty
     * configuration.
     * 
     * <p>
     * This connector builder is used by Spring WebFlux to create the underlying
     * HTTP client for all WebClient instances. It configures:
     * <ul>
     * <li><b>Connection Provider:</b> Manages connection pool with configurable
     * size and lifecycle</li>
     * <li><b>TCP Keep-Alive:</b> Detects and removes broken connections from the
     * pool</li>
     * <li><b>Response Timeout:</b> Prevents indefinite waiting for slow or
     * unresponsive servers</li>
     * </ul>
     * 
     * <p>
     ...
     * Unlike Apache HttpClient's multiple timeout layers, Reactor Netty primarily
     * uses a single response timeout that applies to the entire request/response
     * cycle. This timeout starts when the request is sent and ends when the
     * response completes.
     * 
     ...
     */
    @Bean
    ClientHttpConnectorBuilder<?> nettyConnectorCustomizer() {
